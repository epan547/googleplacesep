...
class GooglePlaces(object):
    ...
    def nearby_search(self, language=lang.ENGLISH, keyword=None, opennow=False, location=None,
...
class Place(object):
    ...
    def opening_hours(self):
        """returns hours for the day the user inputs"""
        pass

    @property
    def price_level(self):
        """ returns 0-4 values for price levels.
            0 - free
            1 - inexpensive
            2 - moderate
            3 - expensive
            4 - very expensive
        """
        if self.price_level == '' and self.price_level != None and 'price_level' in self.details:
            self.price_level = self.details['price_level']
